...
from app.schema.shared.notification import NotificationStatus, NotificationType
...
class Notification(Base):
    ...
    status = Column(Enum(NotificationStatus, name="notification_status_enum"), nullable=False, server_default="pending")
