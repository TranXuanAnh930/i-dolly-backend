...
from app.schema.events.lottery_campaign import LotteryCampaignCreate, LotteryCampaignRead, LotteryCampaignUpdate
from app.services.events.lottery_campaign_service import (
    add_campaign,
    delete_campaign,
    get_campaign,
    get_campaigns,
