...
from app.schema.marketplace.album_detail import AlbumDetailCreate, AlbumDetailRead, AlbumDetailUpdate
from app.services.marketplace.album_detail_service import (
    add_album_detail,
    delete_album_detail,
    get_album_detail,
    get_album_details,
