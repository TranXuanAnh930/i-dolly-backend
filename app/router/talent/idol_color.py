...
from app.schema.talent.idol_color import IdolColorBase, IdolColorCreate, IdolColorRead
from app.services.talent.idol_color_service import add_idol_color, delete_idol_color, get_idol_colors, update_idol_color
