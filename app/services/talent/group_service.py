...
from app.schema.talent.group import GroupCreate, GroupUpdate
from app.services.marketplace.product_service import _build_product_cards
from app.services.talent.idol_service import _with_positions_and_color
